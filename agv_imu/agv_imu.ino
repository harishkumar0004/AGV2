...
// You can tune these through serial:
// SET_IMU_KP 70
// SET_IMU_MAX 250
float KP_IMU_PPS_PER_DEG = 70.0f;
int MAX_IMU_CORR_PPS = 250;
...
// Target PPS requested by controller / Raspberry Pi / IMU controller
int targetLeftPps = 0;
...
void processCommand(const String& cmd) {
  ...
  // ------------------------------------------------
  // Lock current IMU heading and move straight
  // ------------------------------------------------
  ...
  // ------------------------------------------------
  // Adjustable IMU correction strength
  // Example: SET_IMU_KP 70
  // ------------------------------------------------
  ...
  // ------------------------------------------------
  // Adjustable IMU max correction
  // Example: SET_IMU_MAX 250
  // ------------------------------------------------
